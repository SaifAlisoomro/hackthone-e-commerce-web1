...
function Footer() {
  return (
    <footer className="bg-black text-white py-8 px-6 wrapper ">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div className="flex justify-start lg:justify-end items-start gap-4">
          <FaTwitter aria-label="Twitter" className="text-lg cursor-pointer hover:text-gray-400" />
          <FaFacebook aria-label="Facebook" className="text-lg cursor-pointer hover:text-gray-400" />
          <FaYoutube aria-label="YouTube" className="text-lg cursor-pointer hover:text-gray-400" />
          <FaInstagram aria-label="Instagram" className="text-lg cursor-pointer hover:text-gray-400" />
        </div>
      </div>
